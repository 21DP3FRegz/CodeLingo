  ...
  methods: {
    async goHome() {
      try {
        ...
        console.error('An error occurred while navigating to login page:', error);
      }
    }
  },
};
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
      ...
      <p class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">
        We're building epic leaderboards where you can showcase your achievements and compete against friends!
      </p>
      <Button @click="goHome" variant="outline" class="px-8 py-2 m-8">
        Go Home
      </Button>
    </div>
  </section>
